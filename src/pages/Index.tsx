        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="w-full max-w-md animate-fade-in">
            ...
            <div className="mt-6 p-4 rounded-lg border border-border bg-card/50 text-xs text-muted-foreground space-y-2">
              ...
              <p>
                All screen recordings and personal data collected during this competition are accessible only to
                Kodsport Sverige. No data is shared with any third parties.
              </p>
              <p>
                All collected data, including recordings, screenshots, and account information, will be permanently
                deleted after the competition has concluded.
              </p>
            </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-lg mx-auto animate-fade-in">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-foreground mb-2">Programmeringsolympiaden Monitor</h1>
            <p className="text-muted-foreground">Start screen recording to participate in the monitored competition</p>
          </div>
